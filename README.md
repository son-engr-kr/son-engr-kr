...
| Project | Description |
|---------|-------------|
| [**TEKKAL**](https://github.com/son-engr-kr/tekkal) | AI-friendly slide authoring tool — React 19, TypeScript, Monaco Editor ([Live Demo](https://tekkal.dev)) |
| [**BCI Neural Visualization**](https://github.com/son-engr-kr/H2W-brainstorm-track2) | Real-time 1024-channel neural activity visualization for BCI surgery guidance |
| [**Booky**](https://github.com/son-engr-kr/booky-yhack) | Social reading platform with AI-generated solar system visualization (YHack 2026) |

### 💼 Industry Experience

**Gachisoft Inc.** — Software Research Engineer (2021 – 2024)
- Logistics Digital Twin System deployed at Korea Post sites
